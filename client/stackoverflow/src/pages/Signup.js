    ...
    <>
      ...
      <TextContainer>
        <StackOverflow>
          ...
          <UnlockPrivileges>Unlock new privileges like voting and commenting</UnlockPrivileges>
          <SaveFavorites>Save your favorite tags, filters, and jobs</SaveFavorites>
          <EarnReputation>Earn reputation and badges</EarnReputation>
          <Collaborate>Collaborate and share knowledge with a private group for FREE.</Collaborate>
          <StackOverflowCTA><BlueText>Get Stack Overflow for Teams free for up to 50 users</BlueText>.</StackOverflowCTA>
        </StackOverflow>
      </TextContainer>    
        <Rectangle>
          <GoogleButtonContainer>
            <GoogleButton>
              <GoogleIconInterval>
                <FcGoogle />
              </GoogleIconInterval> Sign up with Google </GoogleButton>
          </GoogleButtonContainer>
          <GithubButtonContainer>
            <GithubButton>
              <GithubIconInterval>
                <VscGithub />
              </GithubIconInterval> Sign up with Ggithub </GithubButton>
          </GithubButtonContainer>
          <FacebookButtonContainer>
            <FacebookButton>
              <FacebookIconInterval>
                <AiOutlineFacebook />
              </FacebookIconInterval> Sign up with Facebook </FacebookButton>
          </FacebookButtonContainer>
          <Item>
            <Form>
              ...
              <NewMessage>
                By clicking “Sign up”, you agree to our <BlueText>terms of service</BlueText>, <BlueText>privacy policy</BlueText> and <BlueText>cookie policy</BlueText>
              </NewMessage>
            </Form>
          </Item>
        </Rectangle>
